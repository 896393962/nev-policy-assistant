# 新能源汽车政策与产业信息分析助手后端启动

后端默认面向新能源汽车行业，提供政策/研报知识库、Bocha WebSearch、Text2SQL、行业数据可视化和 Deep Research V2 多 Agent 流式研究接口。
## 启动中间件
cd backend
...
## 修改env文件
填入个人的 DASHSCOPE_API_KEY、BOCHA_API_KEY
BOCHA_API_KEY 获取方法参考：https://open.bochaai.com/
