...
def sse_status(content: str) -> str:
    """Send visible progress before slow retrieval/model calls."""
    return f"event: message\ndata: {json.dumps({'role': 'assistant', 'content': content, 'thinking': True}, ensure_ascii=False)}\n\n"
...
def get_services():
    ...
    web_service = WebSearchService(api_key=config.get('bocha_api_key'))
