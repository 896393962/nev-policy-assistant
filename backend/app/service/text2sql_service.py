...
1. industry_stats (行业统计数据表)
   - id: UUID, 主键
   - industry_name: VARCHAR(100), 行业名称 (当前数据: 新能源汽车)
   - metric_name: VARCHAR(100), 指标名称 (如: 销量、渗透率、充电基础设施保有量、动力电池装机量、出口量、市场规模、同比增长率、研发投入、企业数量、专利申请数、营收)
   ...
   - region: VARCHAR(50), 地区 (如: 全国、上海、北京、广东、江苏、欧洲、东南亚)
   - source: VARCHAR(200), 数据来源
   - created_at: TIMESTAMP, 创建时间

2. company_data (企业数据表)
   - id: UUID, 主键
   - company_name: VARCHAR(200), 企业名称 (如: 比亚迪、特斯拉中国、蔚来、理想汽车、小鹏汽车、宁德时代、亿纬锂能、国轩高科、星星充电、特来电)
   - stock_code: VARCHAR(20), 股票代码 (如: 002594.SZ、TSLA、未上市)
   - industry: VARCHAR(100), 所属行业 (当前数据: 新能源汽车)
   - sub_industry: VARCHAR(100), 细分行业 (如: 整车、动力电池、充电运营、智能驾驶、换电服务、电驱电控)
   - revenue: FLOAT, 营收 (亿元)
...
3. policy_data (政策数据表)
   - id: UUID, 主键
   - policy_name: VARCHAR(500), 政策名称 (如: 新能源汽车产业发展规划、关于进一步构建高质量充电基础设施体系的指导意见、智能网联汽车准入和上路通行试点通知、地方新能源汽车补贴实施细则)
   - policy_number: VARCHAR(100), 政策文号
   - department: VARCHAR(200), 发布部门 (如: 国务院办公厅、国家发展改革委、工业和信息化部、财政部、交通运输部、国家能源局、地方发改委)
   - level: VARCHAR(50), 政策级别 (国家级/省级/市级)
   - publish_date: DATE, 发布日期
   - effective_date: DATE, 生效日期
   - category: VARCHAR(100), 政策类别 (如: 补贴政策、准入规则、充电设施规划、产业扶持、技术标准、试点通知、发展规划、地方法规)
   - industry: VARCHAR(100), 相关行业 (当前数据: 新能源汽车)
   - summary: TEXT, 政策摘要
   - impact_level: VARCHAR(20), 影响程度 (重大/一般/轻微)

当前数据库示例数据:
- 新能源汽车2024年销量: 1286.6万辆
- 新能源汽车2024年渗透率: 40.9%
- 充电基础设施2024年保有量: 1281.8万台
- 动力电池2024年装机量: 548.4GWh
- 比亚迪2024年营收: 7771亿元，整车销量超过400万辆
- 特斯拉中国2024年销量: 约91.6万辆
- 宁德时代2024年动力电池装机量保持行业领先
- 上海、北京、广东等地区有地方补贴、准入或充电设施规划示例政策
"""
