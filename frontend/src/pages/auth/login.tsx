      ...
      <div className={styles['login-container']}>
        ...
        <div className={styles['brand-section']}>
          <div className={styles['brand-content']}>
            ...
            <h1 className={styles['brand-title']}>新能源信息助手</h1>
            <p className={styles['brand-subtitle']}>NEV Policy & Industry Research</p>
            <div className={styles['brand-features']}>
              <div className={styles['feature-item']}>
                <span className={styles['feature-icon']} />
                <span>政策库 RAG 与引用溯源</span>
              </div>
              <div className={styles['feature-item']}>
                <span className={styles['feature-icon']} />
                <span>Bocha 实时搜索补充</span>
              </div>
              <div className={styles['feature-item']}>
                <span className={styles['feature-icon']} />
                <span>多 Agent 产业报告生成</span>
              </div>
            </div>
          </div>
        </div>
